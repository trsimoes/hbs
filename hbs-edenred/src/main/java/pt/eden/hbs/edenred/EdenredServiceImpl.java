...
// */
//@Service
//public class EdenredServiceImpl implements EdenredService {
//
//    private static final Logger log = LoggerFactory.getLogger(EdenredServiceImpl.class);
//
...
//
//    @Override
//    public EdenredSnapshot getCurrentDetails() throws CurrencyException {
//        try {
...
//    }
//
//    private EdenredSnapshot fetchInformation(final WebDriver driver) throws CurrencyException {
//        try {
//            if (log.isTraceEnabled()) {
//                log.trace("Fetch Information - start");
//            }
//            final EdenredSnapshot snapshot = new EdenredSnapshot();
//
//            // account
//            driver.navigate().to(
